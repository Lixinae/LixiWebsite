...
from backend.unused.acronymos import acronymos_bp
from backend.apps.common_data.apps_toolbox import get_words_from_file
...
@acronymos_bp.route('/', methods=['GET', 'POST'])
def acronymos():
